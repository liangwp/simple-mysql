...
function jsonifySQLResult(SQLResult) {
    ...
    // var results = SQLResult.getResults();
    // console.log(results);
    console.log('======== hasData');
    var hasdata = SQLResult.hasData();
    console.log(hasdata);
    // console.log('======== toArray');
    // var toarray = SQLResult.toArray();
    // console.log(toarray);
    console.log('======== getAutoIncrementValue');
    var getautoincrementvalue = SQLResult.getAutoIncrementValue();
    console.log(getautoincrementvalue);
    console.log('========');
